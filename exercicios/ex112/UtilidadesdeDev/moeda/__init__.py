...
# A função "resumo" corresponde ao desafio do exercício 111
def resumo(valor, taxaA=10, taxaR=5):
    print("--"*len('Resumo do Valor'))
    print('Resumo do Valor')
    print("--"*len('Resumo do Valor'))
    print(f'Preço analisado: \t{aumentar(valor, taxaA, formato=True)}')
    print(f'Dobro do preço: \t{dobro(valor, formato=True)}')
    print(f'Metade do preço: \t{metade(valor, formato=True)}')
    print(f'{taxaA}% de aumento: \t\t{aumentar(valor, taxaA, formato=True)}')
    print(f'{taxaR}% de desconto: \t{diminuir(valor, taxaR, formato=True)}')
    print("--" * len('Resumo do Valor'))
